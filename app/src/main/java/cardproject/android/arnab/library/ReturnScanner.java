...
public class ReturnScanner extends AppCompatActivity
{
    String information="";
    RelativeLayout retScanWait;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_return_scanner);

        retScanWait=findViewById(R.id.retScanWait);
        retScanWait.setVisibility(View.GONE);
    ...
    {
        IntentIntegrator integrator=new IntentIntegrator(ReturnScanner.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
        ...
        {
            retScanWait.setVisibility(View.VISIBLE);
                    ...
                    try
                    {
                        ...
                        if (success)
                        {
                            ...
                            if (activeState == 1) {
                                ...
                                {
                                    Intent intent=new Intent(getApplicationContext(),TakeReturn.class);
